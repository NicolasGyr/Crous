...
function Mazing(id) {
  ...
  this.setMessage("D'abord, trouvez la clé");
...
Mazing.prototype.tryMoveHero = function(pos) {
  ...
  if(nextStep.match(/exit/)) {
    if(this.heroHasKey) {
      ...
      this.setMessage("Tu as besoin de la clé pour ouvrir la porte !");
      return;
    }
  }
